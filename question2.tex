...
\end{align}
\begin{align}
   X(z)&=\frac{x(0)}{1-rz^{-1}}\quad\text{ROC:} |z|>|r|
\end{align}

\begin{equation}
X(z) =
\begin{cases}
   \displaystyle\frac{4}{3(2z^{-1}-1)}, & r=+2 \quad\\
 
   \displaystyle\frac{4}{1+2z^{-1}}, & r=-2 \quad\\
\end{cases}
\end{equation}
\begin{centering}
ROC: $z \in (-\infty,-2)\cup(2,\infty)$ \\
\end{centering}
