...
\end{equation}
\begin{align}
\boxed{y(n)=x(0)\brak{\frac{r^{n+1}-1}{r-1}}u(n)}
\end{align}
From \tabref{tab:table1} and eq.\eqref{eq:eq2} :\\
\begin{align}
y(1)=x(0)\brak{\frac{r^2-1}{r-1}}\\
-4=x(0)(r+1)\\
\boxed{x(0)=\displaystyle\frac{-4}{r+1}}
\end{align}\\

\begin{enumerate}
\item For $r=+2$\\
$x(0)=\frac{-4}{3}$ ,\quad $x(n)=\frac{-4}{3}\times(2^n)$\\

$GP_1$: $\frac{-4}{3}$,$\frac{-8}{3}$,$\frac{-16}{3}$,....\\

\item For $r=-2$\\
$x(0)=4$ ,\quad $x(n)=4\times(-2)^n$\\
